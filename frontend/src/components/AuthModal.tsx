                ...
                <div className="relative overflow-hidden rounded-2xl border border-line/50 bg-surface-elevated shadow-[0_24px_80px_rgba(0,0,0,0.5)]">
                  ...
                  <div className="flex flex-col items-center px-8 py-10 gap-6">
                    ...
                    <div className="text-center">
                      <p className="text-base font-semibold text-on-surface">Start learning</p>
                      <p className="mt-1 text-sm text-on-muted">
                        Socratic questioning for CS fundamentals
                      </p>
                    </div>
                    ...
                    <Button
                      ...
                      className="h-12 w-full gap-3 border-line/70 bg-surface text-sm font-medium text-on-surface hover:bg-surface-muted"
                    >
                      {googleLoading ? (
                    ...
                    <p className="text-center text-xs text-on-muted/50">
